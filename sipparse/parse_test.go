...
var msg3 = "REGISTER sip:192.168.159.12:5060 SIP/2.0\r\n" +
...
func TestGetHeaderValue(t *testing.T) {
	successCases := []struct {
		in, header, want string
	}{
		{"Hello:world\r\n", "Hello", "world"},
		{"Hello:world\r\nname: sdf\r\n", "Hello", "world"},
		{"Hello:world\r\nname: sdf\r\n", "name", "sdf"},
		{msg3, "X-CallID", "abcd"},
		{msg3, "From", "<sip:1002@192.168.159.12>;tag=feffa1b1ce68471d8e0a97eb9a1dcb32"},
		{msg3, "To", "<sip:1002@192.168.159.12>"},
		{msg3, "Call-ID", "f44177ddd2aa4e078d4bacbd36a25445"},
		{msg3, "CSeq", "23477 REGISTER"},
		{msg3, "User-Agent", "wellphone/Ver3.0.5"},
	}
	for _, c := range successCases {
		v, err := GetHeaderValue(&c.in, c.header)
